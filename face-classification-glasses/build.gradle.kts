...
android {
    namespace = "com.appliedrec.verid3.faceclassification.glasses"
    compileSdk = 35
...
publishing {
    publications {
        create<MavenPublication>("release") {
            ...
            artifactId = "face-classification-glasses"
            version = "1.0.0"
            afterEvaluate {
                from(components["release"])
            }
            pom {
                name.set("Glasses and sunglasses detection")
                description.set("Detects whether a face has glasses or sunglasses")
